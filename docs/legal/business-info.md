...
| 사업자등록번호 | `XXX-XX-XXXXX` | 운영팀 갱신 대상 |
| 통신판매업 신고번호 | `__TBD__` | 운영팀 갱신 대상 |
| 본사 소재지 | `__TBD__` | 운영팀 갱신 대상 |
| 고객센터 전화 | `__TBD__` | 운영팀 갱신 대상 |
| 대표 이메일 | support@dollsoom.com | 임시 (브랜드 도메인 확정 시 갱신) |
| 도메인 (운영) | dollsoom.com (WooCommerce 쇼핑몰 병행 운영) | 확정 |
...
| 항목 | 값 | 상태 |
|---|---|---|
| 책임자 성명 | `__TBD__` | 운영팀 갱신 대상 |
| 직책 | `__TBD__` | 운영팀 갱신 대상 |
| 연락처 (이메일) | privacy@dollsoom.com | 확정 |
| 연락처 (전화) | `__TBD__` | 운영팀 갱신 대상 |
| 신고/이의신청 채널 | appeals@dollsoom.com | 확정 |
